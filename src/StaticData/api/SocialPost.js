export const Posts = [
  {
    ...
    is_follow: true,
    is_liked: true,
    user: { profile: require('../../assets/images/page-img/18.jpg'), name: 'Nik Jon' },
    comments: [
  ...
  },
  {
    ...
    is_liked: false,
    is_commentLike: true,
    user: { profile: require('../../assets/images/page-img/02.jpg'), name: 'John' },
    comments: [
  ...
  },
  {
    ...
    is_liked: false,
    is_commentLike: true,
    user: { profile: require('../../assets/images/page-img/03.jpg'), name: 'Jack' },
    comments: [
      { image: require('../../assets/images/user/01.jpg'), user: { name: 'Paul Molive', msg: 'Lorem ipsum dolor sit amet', time: '5 min' }, is_commentLike: true },
      { image: require('../../assets/images/user/02.jpg'), user: { name: 'Paul Molive', msg: 'Lorem ipsum dolor sit amet', time: '5 min' }, is_commentLike: true }
    ]
