      ...
      <b-col sm="12">
        <iq-card>
          <template v-slot:body>
            <b-row>
              <b-col lg="6">
                <img :src="image" alt="logo" class="img-fluid avatar-100">
              </b-col>
            ...
            <b-row>
              ...
              <b-col offset="6" cols="6" class="text-right">
                <b-button variant="link text-primary mr-3">
        ...
        order: [
          {
            ...
            orderStatus: 2,
            orderID: '250028',
            billingAddress: 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia <br> Phone: +123 456 7890 <br> Email: demo@Booksto.com <br> Web: www.Booksto.com',
            shippingAddress: 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia <br> Phone: +123 456 7890 <br> Email: demo@Booksto.com <br> Web: www.Booksto.com'
          }
        ],
        orderSummaryFields: [
          {
