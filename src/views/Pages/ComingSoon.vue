               ...
               <div class="row justify-content-center">
                  <div class="col-sm-8 text-center">
                     <div class="iq-comingsoon-info">
                        <a href="#">
                        <img :src="require('../../assets/images/logo-full2.png')" class="img-fluid w-25" alt="">
                        </a>
                        ...
                        <ul class="countdown d-flex align-items-center list-inline" countdown data-date="Feb 02 2022 20:20:22">
