<template>
  <b-container fluid>
      <b-row>
               ...
               <div class="newrealease-contens">
                  <Slick id="newrealease-slider" :option="option1">
                     <li v-for="(image,index) in images" :key="index" class="item">
                        <a href="#">
                           <img :src="image.src" class="img-fluid w-100 rounded" alt="">
                        </a>
                     </li>
                  </Slick>
               </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/02.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/03.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/04.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/05.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/06.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/07.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/08.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent mb-lg-0">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/09.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent mb-md-0 mb-lg-0">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/10.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent mb-sm-0 mb-md-0 mb-lg-0">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/11.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
                     ...
                     <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height browse-bookcontent mb-0 mb-sm-0 mb-md-0 mb-lg-0">
                           <div class="iq-card-body p-0">
                              <div class="d-flex align-items-center">
                                 <div class="col-6 p-0 position-relative image-overlap-shadow">
                                    <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/browse-books/12.jpg" alt=""></a>
                                    <div class="view-book">
                                       <router-link to="/book-page" class="btn btn-sm btn-white">View Book</router-link>
                                    </div>
                                 </div>
         ...
         <b-col lg="6">
            <iq-card className=" iq-card-block iq-card-stretch iq-card-height" headerClass=" mb-0">
               <template v-slot:headerTitle>
               ...
               <template v-slot:body>
                  <div class="row align-items-center">
                     <div class="col-sm-5 pr-0">
                        <a href="#"><img class="img-fluid rounded w-100" src="../../assets/images/page-img/featured-book.png" alt=""></a>
                     </div>
                  ...
                  <ul class="list-inline row mb-0 align-items-center iq-scrollable-block">
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/01.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/02.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/03.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/04.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                           <h6>Thomas R. Toe</h6>
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/05.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/06.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/07.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                           <h6>Desmond Eagle</h6>
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/08.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/09.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                           <h6>Natalya Undgrowth</h6>
                           <p class="mb-0 text-primary">Publish Books: <span class="text-body">2831</span></p>
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/10.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                           <h6>Natalya Undgrowth</h6>
                           <p class="mb-0 text-primary">Publish Books: <span class="text-body">2831</span></p>
                     ...
                     <li class="col-sm-6 d-flex mb-3 align-items-center">
                        <div class="icon iq-icon-box mr-3">
                           <a href="#"><img class="img-fluid avatar-60 rounded-circle" src="../../assets/images/user/11.jpg" alt=""></a>
                        </div>
                        <div class="mt-1">
                           <h6>Natalya Undgrowth</h6>
                           <p class="mb-0 text-primary">Publish Books: <span class="text-body">2831</span></p>
