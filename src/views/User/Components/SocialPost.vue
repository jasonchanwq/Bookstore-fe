        ...
        <div class="d-flex align-items-center">
          <div class="iq-media-group">
            <b-link href="#" class="iq-media">
              <b-img class="avatar-40" rounded="circle" fluid :src="require('../../../assets/images/user/02.jpg')" alt="" />
            </b-link>
            <b-link href="#" class="iq-media">
              <b-img class="avatar-40" rounded="circle" fluid :src="require('../../../assets/images/user/03.jpg')" alt="" />
            </b-link>
            <b-link href="#" class="iq-media">
