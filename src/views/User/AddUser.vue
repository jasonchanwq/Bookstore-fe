              ...
              <template v-slot:body>
                <div class="new-user-info">
                  <b-row>
                    ...
                    <b-form-group class="col-md-6" label="Alter Contact:" label-for="mobno">
                      <ValidationProvider name="Alter Contact" rules="required" v-slot="{ errors }">
                        <b-form-input v-model="user.alter_contact" type="text" placeholder="Alter Contact" :class="(errors.length > 0 ? ' is-invalid' : '')"></b-form-input>
                        <div class="invalid-feedback">
                          <span>{{ errors[0] }}</span>
                        </div>
                      </ValidationProvider>
