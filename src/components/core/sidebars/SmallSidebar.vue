<template>
  <div class="iq-sidebar-small bg-primary">
    ...
    <div class="sidebar-bottom">
      <div class="sidebar-menu-icon">
        <router-link to="/account-setting" class="iq-waves-effect" data-toggle="tooltip" data-placement="right" title="" data-original-title="Setting"><i class="ri-settings-2-fill"></i></router-link>
